...
const routes: Routes = [
  ...
  { path: 'appartement', component: AppartementComponent, canActivateChild: [AuthGuardService] },
  { path: 'register', component: RegisterComponent },
  { path: 'addAppart', component: AddAppartComponent, canActivateChild: [AuthGuardService] },
  { path: 'addVille', component: AddVilleComponent, canActivateChild: [AuthGuardService] },
  { path: 'addBailleur', component: AddBailleurComponent, canActivateChild: [AuthGuardService] },
  { path: 'detail/:id', component: AppartementDetailsComponent, canActivateChild: [AuthGuardService] },
  // ... autres routes
];
